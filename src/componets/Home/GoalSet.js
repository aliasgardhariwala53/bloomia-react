  ...
  const [disable, setdisable] = useState(false);
   ...
   const [goalseted, setgoalseted] = useState(false)
    const [settingGoal, setSettingGoal] = useState({
        set: "1",
        setType: "Beginner",
        // goaltotaltime:"" //uncomment for goal time set
...
const onsetGoal = (e) => {
  ...
  return (
    <div className="p-3 Your-goal row align-items-center m-2">
      ...
      {!disable &&<span  className="ml-auto custom-button-sign-up px-4 py-2 text-light " onClick={disableHandler}>Modify</span>}
      {disable &&<div className="w-100 border-top-black mt-2 pt-3">
        <form onSubmit={onsetGoal}>
          <div className="row m-1 align-items-center">
            <div className="col-lg-4 col-6">
              <div className="text-left">Sets</div>
              <input
                id="sets"
            ...
            <div className="col-6 ">
              <div className="text-left pt-3">Select Type</div>
          ...
          <div className="row m-0 align-items-end">
            ...
            <span className="m-auto w-auto">
                <input type="number" value={settingGoal.goaltotaltime}  onChange={handleGoals} name="goaltotaltime" hidden/ >
                {A} Secs a day.</span>
          </div>
        </form>
      </div>}
